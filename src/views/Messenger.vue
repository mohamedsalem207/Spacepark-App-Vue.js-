      ...
      <div class="chat-container cols-12 col-md-9 pe-4">
        ...
        >
          ...
          >
            ...
            <!-- Content of The Chat -->
            <div class="in-chat d-flex flex-column justify-content-end flex-grow-1 w-100 p-3 overflow-auto">
              <div
                class="chats-container w-100 d-block overflow-auto"
                id="chatMsgs"
              >
  ...
  computed: {
    ...
    filteredChats() {
      return this.chats.filter((chat) =>
        chat.profileName.match(new RegExp(this.searchValue, "i", "g"))
      );
    },
    messages() {
